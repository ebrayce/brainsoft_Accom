    ...
    <div id="signUp" class="w3-row-padding w3-padding-64">
        ...
        <div id="FormContainer" class="w3-col l4 s12 m6  ">
            ...
            <div id="LogInDetails" class="w3-card-4 w3-margin-bottom Theme-dark blue-dark w3-padding w3-round-large">
                <div>
                    <h3 class="Theme-dark blue-dark  w3-round-large w3-padding w3-center w3-block"><b>Edit Location [{{$location->name}}]</b></h3>
                </div>

                <label class=""><b>Name</b></label>
                <input required class="w3-input w3-round-xlarge w3-margin-bottom w3-border "  type="text" placeholder="Location Name" id="FirstName" name="name" value="{{$location->name}}">
