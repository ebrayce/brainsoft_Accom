...
@section('content-middle')
    ...
    <div class="w3-padding-64">
        <div class="w3-card-4 w3-padding">
            <h1 class="w3-block w3-padding w3-center Theme-dark blue-dark">List Of Locations</h1>
                ...
                @if($locations)
                    @foreach($locations as $location )
                        <tr>
                            ...
                            <td>
                                <a href="{{route('location.edit',$location->id)}}" class="w3-btn w3-green w3-round-large">Edit</a>
                            </td>

                            <td>
                                {!! Form::open(['method' => 'DELETE', 'action' => ['LocationController@destroy',$location->id],'onsubmit' => "return confirm('Are you sure you want to delete [Name: ". $location->name. "]?')"]) !!}
